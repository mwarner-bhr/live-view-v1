...
export function TeamHealthPanel({ alerts, insights, employeesById, showRisks, onAlertCta }: TeamHealthPanelProps) {
  return (
    <aside className="space-y-3" aria-label="Team health panel">
      <AlertsLane alerts={alerts} employeesById={employeesById} onAlertCta={onAlertCta} />
